...
export function OrbitingSection() {
  return (
    <div className="relative mx-auto my-7 grid w-full max-w-6xl grid-rows-2 items-start justify-center text-center lg:grid-cols-2 lg:grid-rows-1 lg:items-center lg:justify-start lg:text-left">
